...
public partial class OnboardingWindow : Window
{
    ...
    [
        new(
            "寻找舰队",
            "顶部导航  /  寻找舰队",
            "浏览公开舰队，按玩法、语言、加入方式和活跃时间筛选。",
            "这里是加入长期组织的入口。你可以查看舰队介绍、公开公告、规模、标签和申请条件，再提交加入申请。",
            "打开寻找舰队",
            OnboardingNextAction.FindFleet),
        new(
            "我的舰队",
            "顶部导航  /  我的舰队",
            "查看舰队成员、小队、通讯、事件、指挥与舰船信息。",
            "加入舰队后，这里会成为主要协作空间。不同权限的成员会看到对应的管理入口；尚未加入时则会显示申请与创建引导。",
            "打开我的舰队",
            OnboardingNextAction.MyFleet),
        new(
            "组队大厅",
            "顶部导航  /  组队大厅",
            "寻找临时队友或创建房间，不会改变舰队内的正式小队编制。",
