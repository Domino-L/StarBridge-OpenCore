    ...
    IInformationOverlayReminderSink
{
        ...
        InformationOverlayRuntimeWorkspace workspace)
    {
        ...
        {
            App.WriteDiagnosticLog($"native-overlay-runtime-failed | {exception}");
            TryCloseWindow();
    ...
    private void ConfigureHotkey(string binding, bool enabled)
    {
        ...
        if (_hotkeyState != previousState)
            App.WriteDiagnosticLog($"native-overlay-hotkey-registration | state={_hotkeyState} windowsError={windowsError}");
    }
    ...
    private void RetryGlobalHotkeyRegistration()
    {
        ...
        App.WriteDiagnosticLog("native-overlay-hotkey-registration-recovered");
    }
    ...
    private void HandleHotkeyTrigger(bool requireGameForeground)
    {
        ...
        {
            App.WriteDiagnosticLog($"native-overlay-hotkey-failed | {exception}");
        ...
        try
        {
            ...
            _gameWindowTimer = new DispatcherTimer(
                ...
                (_, _) =>
                {
                    ...
                    {
                        App.WriteDiagnosticLog($"native-overlay-follow-game-failed | {exception}");
                    }
                },
                _dispatcher);
    ...
    private void TryCloseWindow()
    {
        ...
        {
            App.WriteDiagnosticLog($"native-overlay-close-failed | {exception}");
        }
    }
