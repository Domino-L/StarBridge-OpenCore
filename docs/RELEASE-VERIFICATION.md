...
- 官网文件：`StarBridge-0.7.0.3-20260925-03-win-x64-setup.exe`
- GitHub 附件：`StarBridge-0.7.0.3-win-x64-setup.exe`
- 两者 SHA-256：`0d2e8965589917685951cb57b8725512776d92fa58a8711012fe85f566516009`

```powershell
Get-FileHash -Algorithm SHA256 .\StarBridge-0.7.0.3-win-x64-setup.exe
Get-AuthenticodeSignature .\StarBridge-0.7.0.3-win-x64-setup.exe |
    Format-List Status, SignerCertificate, TimeStamperCertificate
```

摘要必须完全一致，签名必须是 `Valid` 且有可信时间戳。应用内更新另行验证
带签名的安装清单，其版本、地址、摘要及公告内容都属于验证范围。
GitHub Release 发布后，还应运行 `gh release verify v0.7.0.3 --repo Domino-L/StarBridge-OpenCore`
